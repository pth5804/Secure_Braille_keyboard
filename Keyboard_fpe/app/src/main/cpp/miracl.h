...
// 사용이 안됨....
/*
extern void TBC_DEC(u8* X, u8* Y, u8 (*RKA)[8], u8 (*RKB)[8], u8 (*TAB)[16]);
extern void TBC_ENC(u8* Y, u8* X, u8 (*RKA)[8], u8 (*RKB)[8], u8 (*TAB)[16]);
extern void FOFE(u8* Z, u8* XBTA, u8* RKa, u8* RKb, u8* TB);
extern void TBC_TS(u8(*TAB)[16], u8* T);
extern void TBC_KS(u8(*RKA)[8], u8(*RKB)[8], u8* K, u8 n);
extern void NumToStr(u64* x, u8* var_after);
extern void StrToNum(u64* x, u8* var);
extern void BitsToNum(u64* y, u8* p);
extern void NumToBits(u64 x, u8* p);
extern void DL(u8* in1);
extern u8 GF28(u8 in1, u8 in2);
extern u32 Binary_MUL(u8 in1, u8 in2);
extern void SBL(u8* X);
extern void ZERO_ARY8(u8* inout);
extern void COPY_ARY8(u8* out, u8* in);
extern void XOR_ARY8(u8* out, u8* in1, u8* in2);
*/
